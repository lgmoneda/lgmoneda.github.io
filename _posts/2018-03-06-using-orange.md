...
However, it's a pretty nice tool for general use and I'll show how to do some basic exploratory data analysis and how to build some predictive models. The data I'm going to use is from a Kaggle competition about loan and it can be downloaded in the [competition's page](https://www.kaggle.com/c/GiveMeSomeCredit/data). The idea is to be able to generate an output to be scored by Kaggle.

**Consider** that I'm very new to this tool so I may not be using it in the best way possible.
