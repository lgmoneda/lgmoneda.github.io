...
Arjovsky et al. (2019) [^fn5] discuss the implications in ML before offering a new framework to deal with it, which I'll cover in a future post.
...
As Arjovsky et al. (2019) states: shuffling data is something that we do, not something Nature does.
