...
2. [Os requisitos de um bom projeto inicial](#the-requirements-of-a-good-starter-project)
3. [Como torná-lo perfeito](#how-to-make-it-perfect)
4. [Relaxando as condições perfeitas](#relaxando-as-condições perfeitas)
5. [A lista de verificação](#the-checklist)
6. [Exemplos](#examples)
...
## Os requisitos de um projeto inicial
